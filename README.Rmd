...
```
   ...
   * This chart shows the number of daily positive cases on the y-axis versus the cumulative total of positive cases on the x-axis, where both axes are on a logarithmic scale. As policy measures are taken and the transmission rate lessens, the trend will decline and become increasingly vertical. A completely vertical line would indicate complete eradication.  

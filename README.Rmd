...
``` 
   ...
   * The instantaneous effective reproduction number, R~e~ is an estimate of the average number of people that an infected person is spreading the virus to for that period.  
   ...
   * R~e~ is estimated over a 7-day window.

...
```
   ...
   * This plot shows the number of daily cases on the y-axis, on a logarithmic scale, versus the cumulative total of cases on the x-axis, also on a logarithmic scale. The axis transformations straightens an exponential curve. As measures are taken and the transmission rate lessens, the trend falls and becomes increasingly vertical. A completely vertical line would indicate complete eradication.  

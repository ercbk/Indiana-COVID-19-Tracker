...
params:
      ...
      exc_death_date: !r as.Date("2020-06-06")
---
...
This repository tracks COVID-19 data statewide and by county. Most of the State and County data for positive tests and deaths are gathered from The New York Times COVID-19 [repository](https://github.com/nytimes/covid-19-data) and The Indiana Data [Hub](https://hub.mph.in.gov/dataset).   
...
```
   ...
   * U.S. average calculated using data from [The COVID <br />
<br />
<br />
...
```{r}
exc_death_path <- glue::glue("plots/excess-death-col-{params$exc_death_date}.png")

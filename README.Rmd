...
```
   ...
   * 7-day moving averages *greater* than 14 day moving averages indicate an *increasing* trend of positive cases.  
   * 7-day moving averages *less* than 14 day moving averages indicate a *decreasing* trend in positive cases. 
...
```
   ...
   * The top 20 counties according to estimated average percent change are shown. Counties at the top are experiencing the highest growth rates in positive test results.

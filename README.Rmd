...
```
   ...
   * Doubling times are calculated from growth rates, so I've included a second y-axis to show how these have changed over time as well. Since the curves are being fit to data, the actual doubling-times won't match-up exactly to points on the curves.  

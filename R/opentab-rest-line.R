...
# Set-up
pacman::p_load(extrafont, swatches, dplyr, lubridate, purrr, ggplot2, glue, ggtext, patchwork, RSelenium)
...
rest_dat_raw <- readr::read_csv(glue("{rprojroot::find_rstudio_root_file()}/data/{filename}"))
